...
const DEFAULT_CONTENT: AboutContent = {
  ...
  faqs: [
    { question: "What services does LibHub provide for buyers and sellers?", answer: "LibHub provides a comprehensive platform for listing, searching, and managing properties across Liberia." },
    { question: "Can I list my property on LibHub as an owner?", answer: "Yes! Once you create an account and get verified, you can list your properties directly." },
    { question: "How can I search for properties on LibHub?", answer: "Use our advanced search filters to find properties by county, type, price range, and more." },
    ...
    { question: "Does LibHub charge fees for its services?", answer: "Browsing is completely free. Optional paid promotion features are available for property owners." },
